...
<head>
    ...
    <title>상세 &gt; 교육현황 &gt; 교육현황 | 한국마약퇴치운동본부</title>
    <script>
        $(function(){
             /*  
        ...
        <div id="content">
            <article id="content_area">
                ...
                <div class="ctn">
                    ...
                    <div class="btn_wrap">
                        <div class="pos_r">
                            <a href="status01_list.jsp" class="btn bg_bk pos_l big">목록</a>
                            <a href="#n" class="btn bg_bk big">수정</a>
                            <a href="status01_list.jsp" class="btn bg_red">교육취소</a>
                        </div>
                    </div>
                    ...
                    <div class="btn_wrap">
                        <div class="pos_c">
                            <a href="status01_list.jsp" class="btn bg_bk sm">증명서발급신청</a>
                        </div>
                    </div>
