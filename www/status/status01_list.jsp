...
<head>
    ...
    <title>목록 &gt; 교육현황 &gt; 교육현황 | 한국마약퇴치운동본부</title>
    <script>
        $(function(){
             /*  
                            ...
                            <table>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>강사양성 > 심화과정</td>
                                        <td>강사양성과정</td>
                                        <td><a href="status01_view.jsp">KAADA 강사양성 심화과정</a><img class="new" src="/KAADA/images/common/ico_new.png" alt="새 목록"></td>
                                    ...
                                    <tr>
                                        ...
                                        <td>강사양성 > 심화과정</td>
                                        <td>강사양성과정</td>
                                        <td><a href="status01_view_2.jsp">KAADA 강사양성 심화과정</a><img class="new" src="/KAADA/images/common/ico_new.png" alt="새 목록"></td>
                                        <td>2020-08-01~2020-09-31</td>
                                        <td>50명</td>
                                        <td>윤정수변호사</td>
                                        <td>신청</td>
