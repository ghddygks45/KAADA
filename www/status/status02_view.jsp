...
<head>
    ...
    <title>상세 &gt; 위탁교육현황 &gt; 교육현황 | 한국마약퇴치운동본부</title>
    <script>
        $(function(){
             /*  
        ...
        <div id="content">
            <article id="content_area">
                ...
                <div class="ctn">
                    ...
                    <div class="board_wrap">
                        <div class="board_intro">
                            ...
                            <div class="btn_wrap pos_r">
                                <div class="c">
                                    <a href="status02_modifi.jsp" class="btn bg_bk big">수정</a>
                    ...
                    <div class="btn_wrap">
                        <div class="pos_r">
                            <a href="status02_list.jsp" class="btn bg_bk pos_l big">목록</a>
                            <a href="status02_list.jsp" class="btn bg_red">교육취소</a>
                            <a href="status02_modifi.jsp" class="btn bg_bk big">수정</a>
                        </div>
                    </div>
                </div>
