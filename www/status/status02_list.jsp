...
<head>
    ...
    <title>목록 &gt; 위탁교육현황 &gt; 교육현황 | 한국마약퇴치운동본부</title>
    <script>
        $(function(){
             /*  
                        ...
                        <div class="tbl_box">
                            <table>
                                ...
                                <tbody>
                                    <tr>
                                        <td>예비예술인</td>
                                        <td>권익보호 교육 > 계약 및 저작권</td>
                                        <td>대면교육</td>
                                        <td><a href="status02_view.jsp">KAADA 강사양성 심화과정</a><img class="new" src="/KAADA/images/common/ico_new.png" alt="새 목록"></td>
