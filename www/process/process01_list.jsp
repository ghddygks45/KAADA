...
<head>
    ...
    <title>목록 &gt; 강사양성과정 &gt; 교육과정 | 한국마약퇴치운동본부</title>
    <script>
        $(function(){
             /*  
            ...
            <article id="content_area">
                <div class="location">
                    <ul>
                        ...
                        <li>교육과정</li>
                        <li class="cur">강사양성과정</li>
                    </ul>
                </div>  
                <h2 class="title">강사양성과정</h2>
                <!-- ctn -->
                <div class="ctn">
                            ...
                            <table>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>강사양성 > 심화과정</td>
                                        <td>강사양성과정</td>
                                        <td><a href="process01_view.jsp">KAADA 강사양성 심화과정</a><img class="new" src="/KAADA/images/common/ico_new.png" alt="새 목록"></td>
