...
<head>
    ...
    <title>상세 &gt; 자체교육과정(교육담당자) &gt; 교육과정 | 한국마약퇴치운동본부</title>
    <script>
        $(function(){
             /*  
        ...
        <div id="content">
            <article id="content_area">
                ...
                <div class="ctn">
                    ...
                    <div class="board_wrap">
                        <div class="board_intro">
                            ...
                            <div class="btn_wrap pos_r">
                                <div class="c">
                                    <a href="process0502_modifi.jsp" class="btn bg_bk big">수정</a>
                                    <a href="#n" class="btn bg_red sm">교육과정삭제</a>
                                </div>
                            </div>
                        </div>
                        <div class="board_box">
                    ...
                    <div class="btn_wrap">
                        <div class="pos_r">
                            <a href="process0502_list.jsp" class="btn bg_bk pos_l big">목록</a>
                            <a href="process0502_modifi.jsp" class="btn bg_bk big">수정</a>
                            <a href="#n" class="btn bg_red sm">교육과정삭제</a>
                        </div>
                    </div>
