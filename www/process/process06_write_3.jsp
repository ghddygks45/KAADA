...
<head>
    ...
    <title>강사 &gt; 등록 &gt; 설문 &gt; 교육과정 | 한국마약퇴치운동본부</title>
    <script>
        $(function(){
             /*  
            ...
            <article id="content_area">
                ...
                <div class="ctn">
                    ...
                    <div class="tab_wrap">
                        <div class="tab_menu">
                            <ul>
                                <li><a href="process06_write.jsp">공통</a></li>
                                <li><a href="process06_write_2.jsp">강의</a></li>
                                <li class="active"><a href="process06_write_3.jsp">강사</a></li>
                    ...
                    <div class="board_wrap">
                        <div class="board_intro">
                            ...
                            <div class="btn_wrap pos_r">
                                <div class="c">
                                    <a href="process06_view_2.jsp" class="btn bg_bk big">이전</a>
                    ...
                    <div class="btn_wrap">
                        <div class="pos_c">
                            <a href="process06_write_2.jsp" class="btn bg_bk big">이전</a>
                            <a href="process06_write_4.jsp" class="btn bg_red big">다음</a>
                        </div>
                    </div>
