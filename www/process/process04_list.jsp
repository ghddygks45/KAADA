...
<head>
    ...
    <title>목록 &gt; 위탁교육과정 &gt; 교육과정 | 한국마약퇴치운동본부</title>
    <script>
        $(function(){
             /*  
            ...
            <article id="content_area">
                <div class="location">
                    <ul>
                        ...
                        <li>교육과정</li>
                        <li class="cur">위탁교육과정</li>
                    </ul>
                </div>  
                <h2 class="title">위탁교육과정</h2>
                <!-- ctn -->
                <div class="ctn">
                    ...
                    <div class="tbl_wrap">
                        <div class="tbl_intro">
                            ...
                            <div class="btn_wrap pos_r">
                                <div class="c">
                                    <a href="process04_write.jsp" class="btn bg_bk">교육신청</a>
                                </div>
                            </div>
                        ...
                        <div class="tbl_box">
                            <table>
                                ...
                                <thead>
                                    <tr>
                                        <th class="order">교육대상<img src="/KAADA/images/common/ico_tbl_th.png" alt="정렬"></th>
                                ...
                                <tbody>
                                    <tr>
                                        <td>예비예술인</td>
                                        <td>권인보호 교육 > 계약 및 저작권</td>
                                        <td>강사양성과정</td>
                                        <td><a href="process04_view.jsp">KAADA 강사양성 심화과정</a><img class="new" src="/KAADA/images/common/ico_new.png" alt="새 목록"></td>
