...
<head>
    ...
    <title>수정 &gt; 위탁교육과정 &gt; 교육과정 | 한국마약퇴치운동본부</title>
    <script>
        $(function(){
             /*  
        ...
        <div id="content">
            <article id="content_area">
                ...
                <div class="ctn">
                    ...
                    <div class="btn_wrap">
                        <div class="pos_c">
                            <a href="process04_list.jsp" class="btn bg_bk big pos_l">목록</a>
                            <a href="process04_list.jsp" class="btn bg_bk">교육수정</a>
                            <a href="process04_list.jsp" class="btn bg_red big">삭제</a>
                        </div>
                    </div>
