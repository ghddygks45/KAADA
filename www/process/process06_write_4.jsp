...
<head>
    ...
    <title>환경 &gt; 등록 &gt; 설문 &gt; 교육과정 | 한국마약퇴치운동본부</title>
    <script>
        $(function(){
             /*  
        ...
        <div id="content">
            <article id="content_area">
                ...
                <div class="ctn">
                    ...
                    <div class="tab_wrap">
                        <div class="tab_menu">
                            <ul>
                                ...
                                <li class="active"><a href="process06_write_4.jsp">환경</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="board_wrap">
                        <div class="board_intro">
                            ...
                            <div class="btn_wrap pos_r">
                                <div class="c">
                                    <a href="process06_view_3.jsp" class="btn bg_bk big">이전</a>
                    ...
                    <div class="btn_wrap">
                        <div class="pos_c">
                            <a href="process06_write_3.jsp" class="btn bg_bk big">이전</a>
                        </div>
                    </div>
