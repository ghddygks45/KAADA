...
<head>
    ...
    <title>상세 &gt; 교육승인관리 &gt; 교육과정 | 한국마약퇴치운동본부</title>
    <script>
        $(function(){
             /*  
        ...
        <div id="content">
            <article id="content_area">
                ...
                <div class="ctn">
                    ...
                    <div class="board_wrap">
                        <div class="board_intro">
                            ...
                            <div class="btn_wrap pos_r">
                                <div class="pos_c">
                                    <a href="#n" class="btn bg_bk big">승인</a>
                        ...
                        <div class="board_box">
                            ...
                            <div class="row">
                                ...
                                <div class="row_double">
                                    ...
                                    <div class="div_td">2020-08-01 13:00</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="btn_wrap">
                        <div class="pos_r">
                            <a href="process08_list.jsp" class="btn bg_bk pos_l big">목록</a>
                            <a href="#n" class="btn bg_bk big">승인</a>
                            <a href="#n" class="btn bg_red w88">미승인</a>
                        </div>
                    </div>
